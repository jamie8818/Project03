...
> 策展思路：現有 13 件已覆蓋卡座／方圓桌／絨布椅／曲木椅／藤椅／吧檯凳，新候選走「形狀變體」（半月、環形卡座）＋「材質變體」（皮革、玻璃、鑄鐵縫紉機腳）＋「站高吧檯桌」＋店內生活道具（店頭床几凳、屏風、麻將桌），避免與既有木/絨布主調重疊；已依 codex 審稿意見換掉偏活動會場感的摺疊椅與偏旅館語境的玄關穿鞋凳、偏薄弱區隔的藤編矮凳。
...
> 策展思路：現有 10 件涵蓋虹吸／磨豆／冰滴／銅壺／收銀機／甜點櫃／冰淇淋櫃，新候選補「手沖」「大型家電」「吧檯內務」「開放展示的視覺亮點」，並在描述上明確與甜點櫃／布丁百匯做內容區隔。
...
> 策展思路：現有 10 件是玻璃窗／海報／菜單牌／掛鐘／油畫／布簾／霓虹／掛曆，新候選補「不同媒材」（木格窗花、琺瑯鐵牌、唱片封面）＋「不同內容題材」（電影、鐵道、書法），避免與既有咖啡廣告海報／單一油畫重疊。
...
> 策展思路：現有燈飾集中在天花吊燈與牆上壁燈，新候選補「立燈」「紙燈籠」「燈串」「桌燈變體」等不同發光形式，並刻意用材質/形式與既有 Tiffany 玻璃吊燈、黃銅壁燈、玻璃罩桌燈做區隔；已依 codex 意見換掉與既有『コーヒー』霓虹燈牌太雷同的霓虹招牌、以及偏洋館舞廳感的水晶吊燈。
...
> 策展思路：現有 7 件已有長毯／圓毯／波斯紋／踏墊／小方毯／幾何毯／榻榻米，新候選補幾種尚未出現的圖案語彙（棋盤格、六角磚紋、波點、菱格、碎花、素面、海浪紋、窄版走廊），全部與既有款式圖案不同。
...
> 策展思路：現有桌上小物集中在糖罐／花瓶／水杯／燭台／電話／菸灰缸與少數飲品甜點，新候選大量補「昭和喫茶招牌餐點」（拿坡里義大利麵、厚蛋三明治、熱蛋糕鬆餅、檸檬蘇打、單點布丁）＋日常餐桌小物（餐巾座、鹽胡椒罐、牛奶壺、吸管罐），拉滿喫茶店的「食物道具箱」。
...
| 候選 | 玻璃水果盤 | fruit_bowl_glass | 1×1 | surface | false | 玻璃盤盛什錦水果，餐後小點 |
| 候選 | 單點布丁 | pudding_solo | 1×1 | surface | false | 素面焦糖布丁單杯，區隔布丁百匯（無水果堆疊） |
| 候選 | 桌邊號碼牌架 | table_number_stand | 1×1 | surface | false | 小型點餐號碼牌立架 |

## 綠植・雜貨（9）

> 策展思路：現有僅一件桌上小盆栽，新候選補「落地大型觀葉植物」「吊掛系」「玻璃容器系」，讓店內綠意分層次（大型角落植物／桌面小品／掛飾），並各自造型明確區隔。
...
## 營運小物（菜單架、傘桶、招財貓、電話台…）（14）

> 策展思路：這節是「開店經營感」道具箱——顧客動線（傘桶、菜單架、意見箱）＋櫃檯內務（招財貓、算盤、打卡鐘、保險箱）＋員工細節（圍裙架、清潔角），補齊喫茶店「活著在營運」的氛圍細節。

| 狀態 | 中文名 | 建議 id | 佔格 w×h | 層 | surface | 說明 |
|---|---|---|---|---|---|---|
| 候選 | 傘桶 | umbrella_stand | 1×1 | furniture | false | 陶製傘桶置於門口 |
| 有 | 招財貓 | maneki_neko | 1×1 | surface | false | 大型招財貓擺件，收銀台旁經典道具 |
...
| 候選 | 營業中吊牌 | open_sign | 1×1 | wall | false | 門口翻牌『營業中／準備中』 |
| 候選 | 落地雜誌架 | magazine_rack_floor | 1×1 | furniture | false | 落地型多本雜誌架，區隔桌上單份報章架 |

## 季節限定（12，單獨一節，讓 JJ 決定要不要）

> 策展思路：這節刻意跳脫「純昭和內聚」限制，涵蓋日本傳統節慶（門松、鏡餅、七夕、盂蘭盆、鯉魚旗）與已被日本商業化的西洋節慶（聖誕樹/花圈、萬聖節南瓜、雪人——後兩者在 1950–70s 尚不算普及，較偏「懷舊喫茶現今營業」的彩蛋向候選，是否收錄請 JJ 自行拿捏）。全部小體積、可快速换季上下架。
...
| 候選 | 雪人擺飾 | snowman_figurine | 1×1 | surface | false | 小型雪人裝飾（偏彩蛋向） |
| 候選 | 盂蘭盆提燈 | obon_lantern | 1×1 | furniture | false | 落地和紙提燈，盂蘭盆節氣氛 |
| 候選 | 迷你鯉魚旗組 | koinobori_mini | 1×1 | wall | false | 室內小型鯉魚旗組，兒童節氣氛 |
